package com.wyekings.uikit.layout
...
abstract class Layout @JvmOverloads constructor(
    ...
    protected fun View.autoMeasure() {
        if (isGone) return
        measure(
            this.defaultWidthMeasureSpec(parentView = this@Layout),
            this.defaultHeightMeasureSpec(parentView = this@Layout)
        )
    }
    ...
    protected fun View.layout(x: Int, y: Int, fromRight: Boolean = false) {
        ...
        if (!fromRight) {
            ...
            layout(this@Layout.measuredWidth - x - measuredWidth, y)
        }
    }
