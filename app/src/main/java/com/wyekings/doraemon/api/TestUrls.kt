...
object TestUrls {
    ...
    val gifUrls =
        listOf(
            "https://img-blog.csdnimg.cn/20190814131833771.gif",
            "https://img-blog.csdnimg.cn/20190814153312214.gif",
            "https://pic2.zhimg.com/v2-cfebcca3eb2bb54a8c9803e5b43e4125_b.webp",
            "https://pic4.zhimg.com/v2-5da8a33aafc8748a04a611b85b3d4c03_b.webp",
            "https://pic1.zhimg.com/v2-e95c21c634eb1e55f89cca93fa276fc0_b.jpg",
            "https://upload-images.jianshu.io/upload_images/1808405-a2726b42e5b94ee1.gif?imageMogr2/auto-orient/strip|imageView2/2/w/400/format/webp",
        )

    fun randomImage(): String = imageUrls.random()

    fun randomGif(): String = gifUrls.random()
}
